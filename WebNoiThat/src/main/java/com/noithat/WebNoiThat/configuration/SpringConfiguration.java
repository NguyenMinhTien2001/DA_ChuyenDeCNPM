package com.noithat.WebNoiThat.configuration;
...
public class SpringConfiguration {
	...
	public DataSource dataSource() {
		...
		dataSource.setPassword("@1310Quan");
	...
	public LocalSessionFactoryBean sessionFactoryBean() {
		...
		bean.setPackagesToScan("com.noithat.WebNoiThat.entity");
	...
	public JavaMailSender getJavaMailSender() {
		...
		mailSenderImpl.setUsername("quant882@gmail.com");
		mailSenderImpl.setPassword("1310quan");
