...
<html>
<head>
<title>Dashboard | NoiThat - Free Bootstrap Dashboard Template</title>
<meta charset="utf-8">
												...
												<div class="panel-heading">
													...
													<p class="demo-button">
														...
														<a class="btn btn-success" href="product-list-by-category?categoryId=3"
															style="background-color: #41B314; padding: 4px 8px; text-decoration: none; border: none; margin-left: 7px;">Bath
															room</a> 
														<a class="btn btn-info" href="product-list-by-category?categoryId=2"
															style="background-color: #E4CB10; padding: 4px 8px; text-decoration: none; border: none; margin-left: 5px;">Bed
															room</a> 
														<a class="btn btn-primary" href="product-list-by-category?categoryId=1"
															style="background-color: #00AAFF; padding: 4px 8px; text-decoration: none; border: none; margin-left: 5px;">Gaming
					                                        room</a> 
														<a class="btn btn-warning" href="product-list-by-category?categoryId=4"
															style="background-color: #D9534F; padding: 4px 8px; text-decoration: none; border: none; margin-left: 5px;">Living
															room</a> 
														<a class="btn btn-danger" href="product-list-by-category?categoryId=5"
															style="background-color: #5BC0DE; padding: 4px 8px; text-decoration: none; border: none; margin-left: 5px;">Kitchen
															</a> 
														<a class="btn btn-danger" href="product-list-by-category?categoryId=6"
															style="background-color: gray; padding: 4px 8px; text-decoration: none; border: none; margin-left: 5px;">Laundry
															room</a>
													</p>
													<div class="right">
														<button type="submit">
															...
															<c:forEach items="${products}" varStatus="loop"
																...
																<tr>
																	...
																	<td style="vertical-align: middle;"><img
																		style="width: 50%;" src="../resource/client/images/products/small/${product.image}"></td>
