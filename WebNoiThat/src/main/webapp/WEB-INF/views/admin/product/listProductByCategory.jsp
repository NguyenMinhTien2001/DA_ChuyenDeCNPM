												...
												<div class="panel-heading">
													...
													<p class="demo-button">
														...
														<a class="btn btn-success" href="product-list-by-category?categoryId=3"
															...
															background-color: #41B314; padding: 4px 8px; text-decoration: none; border: none; margin-left: 7px;">Bath
															room</a>
														<a class="btn btn-info" href="product-list-by-category?categoryId=2"
															...
															background-color: #E4CB10; padding: 4px 8px; text-decoration: none; border: none; margin-left: 5px;">Bed
															room</a> 
														<a class="btn btn-primary" href="product-list-by-category?categoryId=1"
															...
															background-color: #00AAFF; padding: 4px 8px; text-decoration: none; border: none; margin-left: 5px;">Gaming
					                                        room</a> 
														<a class="btn btn-warning" href="product-list-by-category?categoryId=4"
															...
															background-color: #D9534F; padding: 4px 8px; text-decoration: none; border: none; margin-left: 5px;">Living
															room</a> 
														<a class="btn btn-danger" href="product-list-by-category?categoryId=5"
															...
															background-color: #5BC0DE; padding: 4px 8px; text-decoration: none; border: none; margin-left: 5px;">Kitchen
															</a> 
														<a class="btn btn-danger" href="product-list-by-category?categoryId=6"
															...
															background-color: gray; padding: 4px 8px; text-decoration: none; border: none; margin-left: 5px;">Laundry
															room</a>
													</p>
													<div class="right">
														<button type="submit">
