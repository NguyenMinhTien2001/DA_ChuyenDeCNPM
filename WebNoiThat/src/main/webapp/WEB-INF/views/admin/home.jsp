								...
								<div class="col-md-3">
									<a class="metric-link" href="../admin/order-list" style="color: #676A6D;">
										<div class="metric" style="box-shadow: 0 0 3px;">
											...
											<p>
												<span class="number">1</span> <span class="title">Order</span>
											</p>
										</div>
									</a>
								</div>
								<div class="col-md-3">
									<a class="metric-link" href="../admin/product-list"
										...
										<div class="metric" style="box-shadow: 0 0 3px;">
											...
											<p>
												<span class="number">65</span> <span class="title">Product</span>
											</p>
										</div>
									</a>
								</div>
								<div class="col-md-3">
									<a class="metric-link" href="user-list" style="color: #676A6D;">
										<div class="metric" style="box-shadow: 0 0 3px;">
											...
											<p>
												<span class="number">5</span><span class="title">User</span>
											</p>
										</div>
									</a>
								</div>
							...
							<div class="row">
								...
								<div class="col-md-3">
									<div class="weekly-summary text-right">
										<span class="number">2,31</span> <span class="percentage"><i
											class="fa fa-caret-up text-success"></i> 12%</span> <span
											class="info-label">Total Sales</span>
									</div>
									<div class="weekly-summary text-right">
										<span class="number">$4045,758</span> <span class="percentage"><i
											class="fa fa-caret-up text-success"></i> 29%</span> <span
											class="info-label">Monthly Income</span>
									</div>
									<div class="weekly-summary text-right">
										<span class="number">$19265,938</span> <span class="percentage"><i
											class="fa fa-caret-down text-danger"></i> 12%</span> <span
