										...
										<c:forEach items="${sessionScope.cart}" var="cart">
											<tr>
												<td><a href="product-details?productId=${cart.value.productDTO.productId}"><img
														src="../resource/client/images/products/small/${cart.value.productDTO.image}"
														alt=""></a></td>
												<td>
												...
												<td>
													<form action="add-to-cart" method="post">
														...
														</select><input type="hidden" id="productId" value="${cart.value.productDTO.productId}" name="productId" >
													</form>
												</td>
												<td>
													<h5>
