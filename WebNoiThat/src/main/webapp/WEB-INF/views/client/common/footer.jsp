...
<title>Welcome to NoiThat</title>
         ...
         <div class="footer">
            <div class="footer-info">
               <div class="container">
                  <div class="row">
                     <div class="col-md-3">
                        <div class="footer-logo"><a href="#"><img src="../resource/client/images/logo.png" alt=""></a></div>
                     </div>
                     <div class="col-md-3 col-sm-6">
                        <h4 class="title">Contact <strong>Info</strong></h4>
                        <p>No. 08, ChienThang, HoChiMinh , Vietnam</p>
                        <p>Call Us : (084) 1900 1008</p>
                        <p>Email : quant882@gmail.com</p>
                     </div>
                     <div class="col-md-3 col-sm-6">
            ...
            <div class="copyright-info">
               <div class="container">
                  <div class="row">
                     <div class="col-md-6">
                        <p>Copyright © 2022. Designed by <a href="#">Professor Dum</a>. All rights reseved</p>
                     </div>
                     <div class="col-md-6">
